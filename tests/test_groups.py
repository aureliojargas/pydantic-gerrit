"""Tests for Group entity implementations."""
...
class GroupSchemaTests(SchemaTestBase):
    ...
    def test_group_id_type(self, schema: dict[str, Any], test_data_loader: Any) -> None:
        ...
        invalid_data = test_data_loader(
            self.version, self.entity_name, "invalid")
...
class GroupPydanticTests(PydanticTestBase):
    ...
    def test_members_parsing(self, model_class: Any, test_data_loader: Any) -> None:
    ...
    def test_includes_parsing(self, model_class: Any, test_data_loader: Any) -> None:
...
class GroupDataclassTests(DataclassTestBase):
    ...
    def test_nested_dataclasses(self, dataclass: Any, test_data_loader: Any) -> None:
...
class GroupTypeddictTests(TypeddictTestBase):
    ...
    def test_nested_types(self, typeddict_class: Any, test_data_loader: Any) -> None:
