...
class DiffContent(BaseModelGerrit):  # checked
    """
...
class DiffIntralineInfo(BaseModelGerrit):  # totally wrong
    """
    The DiffIntralineInfo entity contains information about intraline edits.

    https://gerrit-review.googlesource.com/Documentation/rest-api-changes.html#diff-intraline-info
    """

    edit_a: int = Field(
        description='The number of characters removed from the old line.',
    )
    edit_b: int = Field(
        description='The number of characters added in the new line.',
    )


class DiffFileMetaInfo(BaseModelGerrit):  # checked
    """
...
class DiffInfo(BaseModelGerrit):  # checked
    """
